      ...
      <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-3">
            <img src={logo} alt="Shashank Car Detailing" className="h-12 sm:h-16 w-auto sm:w-60"/>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-4 lg:gap-8">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="font-display text-xs md:text-sm tracking-wider text-foreground/80 hover:text-primary transition-colors duration-300 relative group"
              >
                {link.name}
          ...
          <div className="hidden md:flex items-center gap-3 lg:gap-6">
            <a href="tel:9506050605" className="flex items-center gap-2 text-foreground/80 hover:text-primary transition-colors">
              ...
              <span className="font-display text-xs md:text-sm tracking-wider">+91 95 06 05 06 05</span>
            </a>
